    ...
    return (
        <div >
             <div className="card-body">
              ...
              <h2 className="card-title">Quiz {index+1} : {question.question}</h2>
              <div >
              <svg onClick={()=> setrightAnswer(question.correctAnswer)}  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 lg:w-6 lg:h-6 h-8">
                ...
                <ToastContainer limit={1} autoClose={550}/>
              </div>
               ...
               <div className='grid lg:grid-cols-2 gap-8 mt-4'>
               {
                    question.options.map(answer =>(
                        <div className='flex items-center'>
                            <input onClick={ () => answerloader(answer, question.correctAnswer)}  type="radio" name="radio-2" className="radio radio-primary" /> 
